...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/workspaces/al-folio/vendor/bundle/ruby/3.3.0/gems/nokogiri-1.17.2/ports/aarch64-linux/libxslt/1.1.42/lib/libxslt-plugins"
#endif
